...
<body>
    ...
    <div class="container">
        ...
        <section class="hero">
            ...
            <h1>
                Agenda una cita con nuestras <span>Psicólogas</span>
            </h1>
            <p>
        ...
        <!-- TARJETAS (Cambio: Ahora mandan el ID numérico en la función seleccionar) -->
        <section class="cards-section">
            ...
            <div class="cards">
                ...
                <!-- ANA (Ejemplo ID: 1) -->
                <div class="card" onclick="seleccionar(1, this)">
                    <div class="card-top">
                        <img src="../img/teachers/analu.jpeg" alt="Ana Nieto">
                    </div>
                    <div class="card-body">
                        <h3>Ana Nieto</h3>
                        <span class="especialidad">Psicóloga Educativa</span>
                        <div class="rating">
                            <i class="fa-solid fa-star"></i> 5.0
                        </div>
                        <div class="info">
                            <p><i class="fa-solid fa-graduation-cap"></i> Atención académica</p>
                            <p><i class="fa-solid fa-clock"></i> Disponible</p>
                        </div>
                        <button type="button">Seleccionar</button>
                    </div>
                </div>

                <!-- JESSICA (Ejemplo ID: 2) -->
                <div class="card" onclick="seleccionar(2, this)">
                    <div class="card-top">
                ...
                <!-- BLANCA (Ejemplo ID: 3) -->
                <div class="card" onclick="seleccionar(3, this)">
                    <div class="card-top">
            ...
            <div class="form-card">
                ...
                <form id="citaForm">
                    <div class="input-group">
                        ...
                        <!-- El input sigue mostrando el texto bonito, pero guardará el ID en un atributo oculto en JS -->
                        <input type="text" id="psicologa" name="psicologa" readonly placeholder="Selecciona una psicóloga">
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <textarea id="motivo" name="motivo" rows="5" placeholder="Describe brevemente el motivo de tu cita..."></textarea>
                    </div>
