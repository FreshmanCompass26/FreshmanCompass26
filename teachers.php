...
if($materia != "English" && $materia != "Computing" && $materia != "Values"){
...
<article class="teacher-card" data-category="<?= $categoria ?>" data-name="<?= strtolower($teacher['nombre']) ?>">
    <div class="teacher-top">
        ...
        <div class="teacher-info">
            ...
            <!-- Enlace mailto directo en la tarjeta -->
            <a href="mailto:<?= htmlspecialchars($teacher['correo']); ?>" class="teacher-email">
                <i class="fa-solid fa-envelope"></i>
                <span><?= htmlspecialchars($teacher['correo']); ?></span>
            </a>
        </div>
    </div>
    ...
    <div class="teacher-footer">
        <span class="teacher-subject"><?= htmlspecialchars($teacher['materia']); ?></span>
